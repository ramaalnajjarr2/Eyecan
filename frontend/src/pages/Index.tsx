  ...
  const technologies = [
      ...
      items: [
        {
          ...
          name: t('eyeTrackingTech'),
          desc: t('eyeTrackingTechDesc'),
        },
        {
          icon: <Mic className="w-6 h-6" />,
          name: t('browserSpeechRecognition'),
          desc: t('browserSpeechRecognitionDesc'),
        },
        {
          icon: <Zap className="w-6 h-6" />,
          name: t('browserInteraction'),
          desc: t('browserInteractionDesc'),
        },
      ],
    },
      ...
      items: [
        {
          icon: <Mic className="w-6 h-6" />,
          name: t('webSpeechApi'),
          desc: t('webSpeechApiDesc'),
        },
        {
          icon: <Languages className="w-6 h-6" />,
          name: t('speechRecognitionTech'),
          desc: t('speechRecognitionTechDesc'),
        },
        {
          icon: <Volume2 className="w-6 h-6" />,
          name: t('speechSynthesisTech'),
          desc: t('speechSynthesisTechDesc'),
        },
      ],
    },
      ...
      items: [
        {
          ...
          name: t('htmlCssJavascript'),
          desc: t('htmlCssJavascriptDesc'),
        },
        {
          icon: <Code className="w-6 h-6" />,
          name: t('reactTech'),
          desc: t('reactTechDesc'),
        },
        {
...

    {
      ...
      items: [
        {
          icon: <Globe className="w-6 h-6" />,
          name: t('futureFrontend'),
          desc: t('futureFrontendDesc'),
        },
        {
          icon: <Server className="w-6 h-6" />,
          name: t('futureBackend'),
          desc: t('futureBackendDesc'),
        },
        {
    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-muted/5 to-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          ...
          {/* Prototype Notice */}
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-10 rounded-lg border border-destructive/30 bg-destructive/5 text-destructive text-sm font-semibold">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in">
            <Link to="/simulation">
              <Button
                size="lg"
                className="group bg-gradient-to-r from-primary to-accent hover:opacity-90 transition-all text-lg px-8 py-6 rounded-2xl"
              >
              ...
              <div key={index} className="space-y-6">
                ...
                <div className="space-y-4">
                  {tech.items.map((item, itemIndex) => (
                    <Card
                      key={itemIndex}
                      className="p-6 hover:shadow-lg transition-all duration-300 border-l-4 border-primary/30"
                    >
